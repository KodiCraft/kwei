--- COMPUTERCRAFT: TWEAKED BIOS FROM VERSION 1.101
--- THIS FILE IS LICENSED UNDER THE COMPUTERCRAFT PUBLIC LICENSE
--- THIS FILE HAS BEEN MODIFIED FROM THE ORIGINAL VERSION FOR IMPROVED COMPATIBILITY WITH KWEI
--- ISSUES WITH THIS FILE ARE CONSIDERED A BUG IN KWEI AND NOT IN CC: TWEAKED
...
os.shutdown = function() os.queueEvent("terminate") end